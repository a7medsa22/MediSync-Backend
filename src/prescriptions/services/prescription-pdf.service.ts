...
export class PrescriptionPdfService {
  ...
  async generatePrescriptionPdf(
    ...
    doc.text(
      `Patient Name: ${prescription.patient.user.firstName} ${prescription.patient.user.lastName}`,
    );
    doc.text(
    ...
    doc
      .fontSize(16)
      .fillColor('#1a73e8')
      .text('Rx (Medications):', { underline: true })
      .moveDown(1);
    ...
    doc
      ...
      .fillColor('#9aa0a6')
      .text(
        'This is an electronically generated prescription from MediSync platform.',
        50,
        bottomY + 15,
        { align: 'center' },
      );
